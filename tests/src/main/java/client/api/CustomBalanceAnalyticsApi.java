...
import com.mastercard.finicity.client.model.CashFlowAnalyticsReport;
import okhttp3.Call;
 ...
 *
 * This class extends the BalanceAnalyticsApi class generated by OpenAPI Generator to
 * support both JSON and PDF report types.
 */
public class CustomBalanceAnalyticsApi  extends BalanceAnalyticsApi {

    public CustomBalanceAnalyticsApi(ApiClient apiClient) {
        super(apiClient);
    }
     ...
     * Get a JSON report.
     */
    public CashFlowAnalyticsReport getObbAnalyticsJsonReport(String obbReportId) throws ApiException {
