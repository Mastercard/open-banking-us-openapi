...
import com.mastercard.openbanking.client.api.PaymentHistoryApi;
 ...
 *
 * This class extends the PaymentHistoryApi class generated by OpenAPI Generator to
 * support both JSON and PDF report types.
 */
public class CustomPaymentHistoryApi  extends PaymentHistoryApi {

    public CustomPaymentHistoryApi(ApiClient apiClient) {
        super(apiClient);
    }
